...
<div class="row">
	...
	<div class="col s12 m8 l9"> 
     	...
     	<div class="slider">
		    <ul class="slides">
		      <li>
		        <img src="<?php echo base_url("images/BUB imag.jpg"); ?>"> <!-- random image -->
		      ...
		      <li>
		        <img src="<?php echo base_url("images/Mobiles.jpg"); ?>"> <!-- random image -->
		      ...
		      <li>
		        <img src="<?php echo base_url("images/fridge.jpg"); ?>"> <!-- random image -->
