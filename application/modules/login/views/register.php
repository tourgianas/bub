...
<html >
  ...
  <body>
  <?php if(isset($user_email_id) && isset($user_city_id) && isset($user_password) && isset($user_password_verify)){
	if($user_password == $user_password_verify){
		if(strlen($user_password) > 6 && preg_match("/([A-Z]+[a-z]+[0-9]+)/", $user_password) ){
			$data = array(
			'email' => $user_email_id,
			'city' => $user_city_id,
			...
			echo "Password was weak. Make sure it is at least six characters. Starts with a letter.";
			echo " At least one number, one lowercase and one uppercase letter.";
		}
	}else{
		echo "Passwords were incorrect. Please try again.";
	}
  }
?>
    ...
    <div class="profile__form">
      <div class="profile__fields">
        ...
        <?php
            ...
            echo form_open('login/reg_data_submitted');
